...
gulp.task('md-clean', function () {
  return gulp.src(['app/md2html','app/articles'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201405', function () {
  return gulp.src(['app/md2html/201405','app/articles/201405'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201406', function () {
  return gulp.src(['app/md2html/201406','app/articles/201406'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201407', function () {
  return gulp.src(['app/md2html/201407','app/articles/201407'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201408', function () {
  return gulp.src(['app/md2html/201408','app/articles/201408'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201409', function () {
  return gulp.src(['app/md2html/201409','app/articles/201409'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201410', function () {
  return gulp.src(['app/md2html/201410','app/articles/201410'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201411', function () {
  return gulp.src(['app/md2html/201411','app/articles/201411'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201412', function () {
  return gulp.src(['app/md2html/201412','app/articles/201412'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201501', function () {
  return gulp.src(['app/md2html/201501','app/articles/201501'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201502', function () {
  return gulp.src(['app/md2html/201502','app/articles/201502'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201503', function () {
  return gulp.src(['app/md2html/201503','app/articles/201503'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201505', function () {
  return gulp.src(['app/md2html/201505','app/articles/201505'], {read: true}).pipe(clean());
});
...
gulp.task('md-clean-201506', function () {
  return gulp.src(['app/md2html/201506','app/articles/201506'], {read: true}).pipe(clean());
});
